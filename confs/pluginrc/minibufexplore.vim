...
" <max lines: defualt 0> setting this to 0 will mean the window gets as big as 
" needed to fit all your buffers.
let g:miniBufExplMaxSize = 1 

" There is a Vim bug that can cause buffers to show up without their highlighting. 
